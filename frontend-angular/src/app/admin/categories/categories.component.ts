...
export class CategoriesComponent implements OnInit {
  ...
  onClickSubmit(data:any){
    ...
    console.log(data);
    this.api.post("bookcategory/save", {data:data}).subscribe((result:any)=>{
      this.bind();
    });
  }
  ...
  deletecategory(id:string){
    if(confirm("Sure to delete?")){
      this.api.post("bookcategory/delete", {data:{id:id}}).subscribe((result:any)=>{
        this.bind();
      });
    }
  }
  ...
  editcategory(id:string){
    this.api.post("bookcategory/get", {data:{id:id}}).subscribe((result:any)=>{
